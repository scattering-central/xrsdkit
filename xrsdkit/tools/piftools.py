...
def make_pif(uid,expt_id=None,t_utc=None,q_I=None,temp_C=None,populations=None):
    ...
    csys.properties = saxs_properties(q_I,temp_C,populations)
    return csys
...
def saxs_properties(q_I,temp_C,populations):
    properties = []
    classifications = []
    ...
    if populations is not None:
        ...
        for i,popd in enumerate(populations):
            c_lat = pifobj.Classification('lattice_{}'.format(i),lattice_name)
            classifications.append(c_lat)        
