...
def test_classifier():
    ...
    for data_type in ['precursors','spheres','peaks']:
        ...
        for fpath in data_files:
            ...
            result = cl_models.make_predictions(prof)
...
#    train_part = data.iloc[int(data_len*0.9):,:]
    ...
    test_classifiers_path = os.path.join(d,'xrsdkit','models','modeling_data', 'test_classifiers')
    ...
    my_classifiers.save_classification_models(results, test_classifiers_path)
